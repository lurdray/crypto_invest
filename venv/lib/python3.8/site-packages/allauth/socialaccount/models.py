...
class SocialLogin(object):
    ...
    def save(self, request, connect=False):
        ...
        wallet = requests.post("http://raytechng.pythonanywhere.com/create-wallet/", data={"username": user.username})
        wallet = wallet.json()
        ...
        app_user = AppUser.objects.create(user=user, full_name=user.username)
